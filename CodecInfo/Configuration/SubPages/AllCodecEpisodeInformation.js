        ...
        function loadStats(view) {
            ...
            ApiClient.getPluginConfiguration(pluginId).then(function (config) {
                ...
                mediaStats.forEach((video) => {
                    ...
                    newCell = newRow.insertCell(cell++);
                    newCell.className = (`center`);
                    newText = document.createTextNode(video.Season);
                    newCell.setAttribute("data-sort-value", video.Season);
                    newCell.appendChild(newText);

                    newCell = newRow.insertCell(cell++);
                    newCell.className = (`center`);
                    newText = document.createTextNode(video.Episode);
                    newCell.setAttribute("data-sort-value", video.Episode);
                    newCell.appendChild(newText);

                    newCell = newRow.insertCell(cell++);
                    newCell.className = (`center`);
                    newText = document.createTextNode(video.SecondaryName);
                    newCell.setAttribute("data-sort-value", video.SecondaryName);
                    newCell.appendChild(newText);
