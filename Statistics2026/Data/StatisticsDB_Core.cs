    ...
    public sealed partial class StatisticsDB
    {
        ...
        public static StatisticsDB GetExistingInstance()
        {
            lock (_padlock)
            {
                if (instance == null)
                {
                    throw new ArgumentNullException("No existing instance found.");
                }
                return instance;
            }
        }
        ...
        private async Task CreateTables()
        {
            if (_dbHelper == null || _dbHelper?._connection == null)
                throw new ArgumentNullException("_dbHelper or dbHelper._connection is null ");
            ...
            new TableDef("LastUpdateTable",
                ...
                null
            ).Execute(clearFirst, _dbHelper._connection);
